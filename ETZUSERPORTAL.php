<?php
	if (isset($_POST['submit_email']))
    {
		...
		{
			$sql_u = "SELECT * FROM members WHERE Email='" . $_POST["email"] . "'";
			$res_u = mysqli_query($conn, $sql_u);
			if (mysqli_num_rows($res_u) <= 0)
			{
				$sql=mysqli_query($conn,"INSERT INTO members (Name,Password,Email,Cpassword,Gender,Phone,DOB) VALUES ('$_POST[fname]','$_POST[password]','$_POST[email]','$_POST[cpassword]','$_POST[gender]','$_POST[phone]','$_POST[dob]')");
				$result = mysqli_query($conn,"SELECT * FROM members WHERE Email='" . $_POST["email"] . "'");
				...
				if($count>0) 
				{
					...
					$result = mysqli_query($conn,"UPDATE members SET Memid= $otp WHERE Email='" . $_POST["email"] . "'");	
					$message = "You are a Member now! Please login with your member id sent to your mail";
			        echo "<script type='text/javascript'>alert('$message');
			        </script>";  
			        header("refresh: 0;"); 
			        die(" ");
	...
	if (isset($_POST['login_user']))
	{
		...
		if (count($errors) == 0) 
		{
			$query = "SELECT * FROM members WHERE Memid='$Memberid' AND Email='$email' AND Password='$password'";
...
$row=mysqli_fetch_array($results);
 ...
 if($count==1) {
  ...
  header("location: ETZMEMBERPORTAL.php");
$message = "You are now logged in";
	...
	if (isset($_POST['register_event']))
	{
		...
		{	
			$sql="INSERT INTO eventreg(eventcode,name,email,guests,regtype) VALUES ('$_POST[eventcode]','$_POST[name]','$_POST[email]','$_POST[guests]','$_POST[regtype]')";
			if ($conn->query($sql) === TRUE) 
			{
				$result = mysqli_query($conn,"SELECT * FROM eventreg WHERE email='" . $_POST["email"] . "'");
				$count  = mysqli_num_rows($result);
				if($count>0) 
				{
					require_once("mail_functionevent.php");
					$mail_status = sendConfirmation($_POST["email"],$_POST["eventcode"]);
				}
	...
	if (isset($_POST['volunteer_event']))
    {
		include('connect_db.php');    	
		if (empty($_POST['eventcode']) ||
		empty($_POST['name']) ||
		...
		{	
			$sql="INSERT INTO eventvol(eventcode,name,email) VALUES ('$_POST[eventcode]','$_POST[name]','$_POST[email]')";
			if ($conn->query($sql) === TRUE) {
			$result = mysqli_query($conn,"SELECT * FROM eventreg WHERE email='" . $_POST["email"] . "'");
			$count  = mysqli_num_rows($result);
			if($count>0) 
			{
				require_once("mail_functioneventvol.php");
				$mail_status = sendConfirmation($_POST["email"],$_POST["eventcode"]);
			}
			$message = "You have successfully registered to volunteer for an event";
			echo "<script type='text/javascript'>alert('$message');
			</script>";
		}
	}
							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">		  
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="smooth-menu"><a href="#JoinUs">Join</a></li>
        					...
        					<div id="desc-tabs" class="desc-tabs">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation" class="active">
									 	<a href="#BecomeMember" aria-controls="tours" role="tab" data-toggle="tab">
									...
									<li role="presentation">
										<a href="#MemberLogin" aria-controls="hotels" role="tab" data-toggle="tab">
								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane active fade in" id="BecomeMember">
										<div class="tab-para">
												...
												<div class="col-lg-2 col-md-1 col-sm-4">
													<div class="single-tab-select-box">
														...
														<div class="trav">
																...
																<input type="phone" name="phone" class="form-control" placeholder="Mobile Number"><br>
												...
												<div class="col-lg-2 col-md-3 col-sm-4">
													<div class="single-tab-select-box">
														...
														<div class="trave">
																...
																<input type="DATE" name="dob" class="form-control" data-toggle="datepicker" placeholder="12-01-1995 ">
									...
									<div role="tabpanel" class="tab-pane fade in" id="MemberLogin">
										<div class="tab-para">
											<form name="mynewForm" action="" method="post" onsubmit="return validatesecondForm()">
											<div class="row">
												<div class="col-lg-3 col-md-4 col-sm-12">
													<div class="single-tab-select-box">
														...
														<div class="trave">
																...
																<input type="id" name="Memberid" class="form-control" placeholder="Member ID"><br>
											...
											<div class="row">
												...
												<div class="clo-sm-7">
													<div class="about-btn travel-mrt-0 pull-right">
														<div class="tableheader"><input type="submit" name="login_user" value="Login" class="btnSubmit" ></div>
													</div><!--/.about-btn-->
												</div><!--/.col-->
	...
	<!-- footer-copyright start -->
		<footer  class="footer-copyright">
			<div class="container">
				...
				<div id="mybutton">
					<button id="mySizeChart" class="feedback" ><i class="fa fa-comments"></i></button>
				...
				<div id="mySizeChartModal" class="ebcf_modal">
					...
					<div class="ebcf_modal-content">
  						...
  						<button type="button" id="pro-close"  data-dismiss="modal" aria-label="Close" style="color: #aaaaaa;
	  						margin: 2px 450px; 
	  						font-size: 28px;
	  						font-weight: bold;">
				  			<span aria-hidden="true">&times;</span>
  						...
  						<div class="modal-area">
							...
							<input id="opentab2" type="radio" name="modaltabs" checked="checked"/>
							<label for="opentab2"></label>
...
var ebSpan = document.getElementById("pro-close");
